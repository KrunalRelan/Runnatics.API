...
namespace Runnatics.Api.Controller
{
    ...
    public class EventsController(IEventsService eventService) : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="request">Optional search/filter criteria</param>
        ...
        /// }
        /// 
        /// All parameters are optional. If no request body is provided, returns all events with default pagination.
        /// </remarks>
        ...
        public async Task<IActionResult> GetAllEvents([FromBody] EventSearchRequest? request = null)
        {
            // Use default search criteria if none provided
