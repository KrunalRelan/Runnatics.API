...
namespace Runnatics.Services.Interface
{
    ...
    {
        Task<FileUploadResponse> UploadFileAsync(FileUploadFormRequest request, int userId);
        ...
        Task<FileUploadBatchListDto> GetBatchesAsync(string raceId, int pageNumber = 1, int pageSize = 20);
